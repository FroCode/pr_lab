...
theme: default
paginate: true
header: 'MedCore AI - WSB University'
footer: 'Team: Maamar, Alaeddine, Abdennour, Noufel'
...
graph TB
    ...
    SM <--> CE[Context Extractor]
    CE -- Prompt --> AI[Gemini 2.5 API]
    AI -- JSON --> SM
    SM --> KB[Diagnostic Archive]
```
